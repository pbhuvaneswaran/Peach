...
import AppHomeV2 from './pages/v2/AppHome'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/v2/pricing" element={<Layout><PricingV2 /></Layout>} />
        <Route path="/v2/app" element={<Layout noFooter><AppHomeV2 /></Layout>} />
        <Route path="/pricing" element={<Layout><PricingV2 /></Layout>} />
        <Route path="/app" element={<Layout noFooter><AppHomeV2 /></Layout>} />
